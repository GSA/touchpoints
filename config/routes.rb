...
Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    get '/reporting/hisps/hisp_service_cx_data_collections', to: 'reporting#hisp_service_cx_data_collections',
                                                             as: :hisp_service_cx_data_collections
    get '/reporting/hisps/hisp_service_cx_data_collections_summary',
        to: 'reporting#hisp_service_cx_data_collections_summary', as: :hisp_service_cx_data_collections_summary
    ...
    resources :service_providers do |*_args|
      ...
      member do
        ...
        post 'add_service_provider_manager', to: 'service_providers#add_service_provider_manager',
                                             as: :add_service_provider_manager
        post 'remove_service_provider_manager', to: 'service_providers#remove_service_provider_manager',
                                                as: :remove_service_provider_manager
      end
    end
