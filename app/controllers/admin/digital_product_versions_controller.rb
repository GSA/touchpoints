...
module Admin
  class DigitalProductVersionsController < ApplicationController
    ...
    def digital_product_version_params
      params.require(:digital_product_version).permit(:digital_product_id, :store_url, :platform, :version_number,
                                                      :publish_date, :description, :whats_new, :screenshot_url, :device, :language, :average_rating, :number_of_ratings)
    end
  end
end
