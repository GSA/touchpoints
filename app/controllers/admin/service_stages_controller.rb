  ...
  class ServiceStagesController < AdminController
    ...
    def create
      ...
      if @service_stage.save
        redirect_to admin_service_service_stage_path(@service, @service_stage),
                    notice: 'Service stage was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      ...
      if @service_stage.update(service_stage_params)
        redirect_to admin_service_service_stage_path(@service, @service_stage),
                    notice: 'Service stage was successfully updated.'
      else
        render :edit
      end
    end
