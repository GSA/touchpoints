class Admin::OfferingsController < ApplicationController
  ...
  before_action :set_offering, only: [:show, :edit, :update, :destroy, :add_offering_persona, :remove_offering_persona]

  before_action :set_offering_persona_options, only: [
    :new,
    :create,
    :edit,
    :update,
  ...
  def set_offering_persona_options
    ...
    if @offering_persona_options && @offering
      @offering_persona_options = @offering_persona_options - @offering.offering_personas
    end
  end
