  ...
  class OrganizationsController < AdminController
    ...
    def performance_update
      respond_to do |format|
        if @organization.update(organization_params)
          format.html do
            redirect_to performance_admin_organization_path(@organization),
    ...
    def search
      ...
      if search_text.present?
        ...
        @organizations = Organization.where(' domain ilike ? or name ilike ? or abbreviation ilike ? or url ilike ?  ',
