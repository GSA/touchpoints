  ...
  class GoalTargetsController < AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @goal_target.save
          format.html do
            redirect_to admin_goal_goal_target_path(@goal, @goal_target),
                        notice: 'Goal target was successfully created.'
          end
    ...
    def update
      ...
      respond_to do |format|
        if @goal_target.update(goal_target_params)
          format.html do
            redirect_to admin_goal_goal_target_path(@goal, @goal_target),
                        notice: 'Goal target was successfully updated.'
          end
    ...
    def goal_target_params
      params.require(:goal_target).permit(:goal_id, :target_date_at, :assertion, :kpi, :starting_value, :target_value,
                                          :current_value)
    end
  end
end
