  ...
  class OmbCxReportingCollectionsController < AdminController
    ...
    def create
      ...
      if @omb_cx_reporting_collection.save
        redirect_to admin_omb_cx_reporting_collection_path(@omb_cx_reporting_collection),
                    notice: 'Omb cx reporting collection was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @omb_cx_reporting_collection.update(omb_cx_reporting_collection_params)
        redirect_to admin_omb_cx_reporting_collection_path(@omb_cx_reporting_collection),
                    notice: 'Omb cx reporting collection was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to admin_collection_url(@omb_cx_reporting_collection.collection),
                  notice: 'Omb cx reporting collection was successfully destroyed.'
    end
    ...
    def set_collections
      @collections = if admin_permissions?
                       Collection.all
                     else
