...
class ExportFormAndA11V2Job < ApplicationJob
  queue_as :default
  ...
  def perform(email:, form_uuid:, start_date:, end_date:)
    ...
    csv_content = Form
      ...
      .to_combined_a11_v2_csv(start_date:, end_date:)
    filename = "touchpoints-combined-a11-v2-form-responses-#{timestamp_string}.csv"
