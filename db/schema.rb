...
ActiveRecord::Schema[7.0].define(version: 20_220_621_210_703) do
  ...
  create_table 'organizations_roles', id: false, force: :cascade do |t|
    ...
    t.bigint 'role_id'
    t.index %w[organization_id role_id], name: 'index_organizations_roles_on_organization_id_and_role_id'
  ...
  create_table 'user_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[user_id form_id], name: 'index_user_roles_on_user_id_and_form_id', unique: true
  end
