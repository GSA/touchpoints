...
feature 'Touchpoints', js: true do
  ...
  context 'as Admin' do
    ...
    describe 'radio buttons question' do
      ...
      let!(:last_radio_option) do
        radio_button_form.questions.first.question_options.create!(text: 'other', value: 'other', position: 6)
      end
  ...
  context 'as public user' do
    ...
    describe '/touchpoints' do
      let!(:form) do
        FactoryBot.create(:form, :open_ended_form, organization:, user: admin, aasm_state: 'in_development')
      end
    ...
    describe '/touchpoints' do
      let!(:form) do
        FactoryBot.create(:form, :open_ended_form, organization:, user: admin, aasm_state: 'archived')
      end
    ...
    describe '/touchpoints' do
      let!(:form) do
        FactoryBot.create(:form, :open_ended_form, organization:, user: admin, aasm_state: 'live')
      end
