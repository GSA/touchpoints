      ...
      context '#show' do
        ...
        describe 'xss injection attempt' do
          context 'when no Submissions exist' do
            before do
              FactoryBot.create(:submission, form:,
                                             answer_01: 'content_tag(&quot;/&gt;&lt;script&gt;alert(&#39;hack!&#39;);&lt;/script&gt;&quot;)')
    ...
    describe '/forms/:id with submissions' do
      ...
      context '#show' do
        ...
        context 'for a form with a text_display element' do
          context 'with one Submission' do
            let(:form_with_text_display) do
              FactoryBot.create(:form, :kitchen_sink, organization:, user: form_manager)
            end
            let!(:user_role) do
              FactoryBot.create(:user_role, :form_manager, user: form_manager, form: form_with_text_display)
            end
