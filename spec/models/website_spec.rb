...
RSpec.describe Website, type: :model do
  ...
  describe 'try to create a new website' do
    ...
    it 'does not save and adds an error indicating domain is required' do
      ...
      expect(@website.errors.full_messages).to eq(["Domain can't be blank", "Domain must be formatted as a domain", "Domain domain must have a valid suffix, like .gov or .mil", "Type of site can't be blank"])
    end
  end
