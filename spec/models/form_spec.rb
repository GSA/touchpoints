...
RSpec.describe Form, type: :model do
  ...
  context 'newly created Form' do
    ...
    describe '#hashed_fields_for_export' do
      before do
        ...
        q3 = form.questions.create!(answer_field: 'answer_03', text: '03',
                                    form_section_id: form.form_sections.first.id, question_type: 'text_field', position: 3)
        q2 = form.questions.create!(answer_field: 'answer_02', text: '02',
                                    form_section_id: form.form_sections.first.id, question_type: 'text_field', position: 2)
        q4 = form.questions.create!(answer_field: 'answer_10', text: '10', form_section_id: second_form_section.id,
                                    question_type: 'text_field', position: 1)
        q5 = form.questions.create!(answer_field: 'answer_04', text: '02', form_section_id: second_form_section.id,
                                    question_type: 'text_field', position: 2)
      end
  ...
  describe 'dependent data relations' do
    ...
    let!(:user_role) do
      FactoryBot.create(:user_role, user:, form: form_without_responses, role: UserRole::Role::FormManager)
    end
